...
namespace Task3
{
    class Author
    {
        ...
        public void Show ()
        {
            Console.ForegroundColor = ConsoleColor.Red;     //ForegroundColor - цвет для шрифта!    //(BackgroundColor - для фона.)
            Console.WriteLine(Content);
            Console.ForegroundColor = ConsoleColor.Gray;    //Возврат цвета.
        }
    }
}
